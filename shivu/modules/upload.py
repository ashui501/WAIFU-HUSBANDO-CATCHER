...
rarity_map = 1 (⚪️ Common), 2 (🟣 Rare), 3 (🟡 Legendary), 4 (🟢 Medium), 5 (💮 Limited), 6 (🔮 Super Rare), 7 (⚜️ Infinity Edition) 8 (🏺 Legendary Edison)"""
...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟣 Rare", 3: "🟡 Legendary", 4: "🟢 Medium", 5: "💮 Limited", 6: "🔮 Super Rare", 7: "⚜️ Infinity Edition", 8: "🏺 Legendary Edison"}
        try:
